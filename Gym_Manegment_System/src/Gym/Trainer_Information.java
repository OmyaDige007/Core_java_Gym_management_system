...
{
	String x[]= {"Trainer Id","Name","Father's name","Email","Address","Contact no","Emg.No","catg.","min aggrement","gender","Height","Remark"};
	JButton bt;
	JPanel p1,p2,p3;
	JLabel l1,l2;
	JTextField tf1;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==bt)
		{
			try
			{
				...
				String q="delete from add_trainer where tid='"+tid+"'";
				obj1.stm.executeLargeUpdate(q);
				setVisible(false);
